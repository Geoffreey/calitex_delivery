...
<div class="p-4 sm:p-8 space-y-6 lg:space-y-8">
  <section>
    <div class="mb-6">
      <h2 class="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white tracking-tight leading-tight">Good morning, CaliTex Dispatcher</h2>
      <p class="text-slate-500 text-sm sm:text-base">Here is what's happening with your fleet today.</p>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
      <div class="bg-white dark:bg-slate-900 p-5 sm:p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm hover:border-primary/30 transition-colors">
        ...
        <h3 class="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white mt-1">128</h3>
      </div>
      <div class="bg-white dark:bg-slate-900 p-5 sm:p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm hover:border-emerald-500/30 transition-colors">
        ...
        <p class="text-slate-500 text-sm font-medium">Delivered (Last 24h)</p>
        <h3 class="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white mt-1">1,402</h3>
      </div>
      <div class="bg-white dark:bg-slate-900 p-5 sm:p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm border-l-4 border-l-accent-orange hover:border-accent-orange/30 transition-colors sm:col-span-2 lg:col-span-1">
        ...
        <p class="text-slate-500 text-sm font-medium">Pending Action</p>
        <h3 class="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white mt-1">14</h3>
      </div>
    </div>
  </section>
