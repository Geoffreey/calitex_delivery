...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $cliente_id) {
  ...
  try {
    ...
    $stmt = $pdo->prepare("INSERT INTO envios (cliente_id, auxiliar_id, direccion_origen_id, direccion_destino_id, nombre_destinatario, telefono_destinatario, descripcion, pago_envio) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->execute([$cliente_id, $auxiliar_id, $direccion_origen_id, $direccion_destino_id, $nombre_destinatario, $telefono_destinatario, $descripcion, $pago_envio]);
