  ...
  <div class="flex h-screen overflow-hidden relative">
    <aside class="sidebar-mobile-hidden lg:sidebar-mobile-visible fixed inset-y-0 left-0 z-50 w-64 lg:relative flex-shrink-0 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex flex-col transition-all duration-300 ease-in-out" id="sidebar">
      ...
      <nav class="flex-1 px-4 space-y-1 overflow-y-auto">
        <a href="dashboard.php" class="nav-item flex items-center gap-3 px-3 py-2 rounded-lg bg-primary/10 text-primary" href="dashboard.php">
        ...
        <a href="paquetes_asignados.php" class="nav-item flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" href="pilotos.php">
          <span class="material-symbols-outlined flex-shrink-0">bike_lane</span>
          <span class="text-sm font-medium nav-text">Envios</span>
        </a>
        <a href="ruta_asignada_recoleccion.php" class="nav-item flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" href="auxiliares.php">
          <span class="material-symbols-outlined flex-shrink-0">contact_emergency</span>
          <span class="text-sm font-medium nav-text">Recolecciones</span>
        </a>
        ...
        <a class="nav-item flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" href="perfil.php">
          <span class="material-symbols-outlined flex-shrink-0">power_settings_circle</span>
          <span class="text-sm font-medium nav-text">Miperfil</span>
        </a>
      ...
      <header class="h-auto lg:h-16 flex flex-col lg:flex-row items-center justify-between px-4 sm:px-8 py-3 lg:py-0 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-40 gap-4">
        ...
        <div class="flex items-center justify-between w-full lg:w-auto gap-4">
          ...
          <button class="flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-lg text-sm font-bold shadow-lg shadow-primary/20 hover:bg-primary/90 transition-all whitespace-nowrap">
            ...
            <a href="crear_envio.php" class="hidden sm:inline">Crear nuevo envío</a>
            <a href="crear_envio.php" class="sm:hidden">Nuevo envio</a>
          </button>
        </div>
      </header>   